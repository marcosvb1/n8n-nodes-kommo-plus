...
const updateTransactionModel: INodeProperties[] = [
	...transactionModelDescription,
	{
...
export const description: ITransactionsProperties = [
	...addJsonParametersDescription(displayOptions),
	{
		...
		required: true,
		description:
			'Select catalog. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code-examples/expressions/">expression</a>. Choose from the list, or specify an ID using an <a href="https://docs.n8n.io/code/expressions/">expression</a>.',
		displayOptions,
	},
	{
		displayName: 'Transactions',
		name: 'collection',
		placeholder: 'Add edited transactions',
